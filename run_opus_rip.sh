...
seat-run -m opus -q "$(cat "$RIPDIR/lens_1.txt")" -C ~/git/Erebus.jl > rip_opus_result1.txt 2>rip_opus_err1.txt &
P1=$!
seat-run -m opus -q "$(cat "$RIPDIR/lens_2.txt")" -C ~/git/Erebus.jl > rip_opus_result2.txt 2>rip_opus_err2.txt &
P2=$!
