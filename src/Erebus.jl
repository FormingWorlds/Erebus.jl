...
export Config,
    ...
    compute_cell_peclet_number,
    compute_local_radial_gravity,
    compute_hydrothermal_layer_thickness,
    ...
    compute_surface_mean_delta_iw,
    compute_surface_venting_rates,
