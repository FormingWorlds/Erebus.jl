...
| **Silicate Rock Melting** | Linear melt fraction, latent heat via apparent heat capacity, and melt-weakened rheology | Gerya (2019); Costa et al. (2009) | `test/test_melting.jl`, `test/test_stefan_benchmark.jl` |
