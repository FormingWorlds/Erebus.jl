            ...
            for color in 1:4
                ...
                Threads.@threads :dynamic for t in tiles
                    ...
                    for idx in lo:hi
                        ...
                        scatter_marker_to_master_grids!(
                            m, xm[m], ym[m], coords,
                            dummy_vec, dummy_vec, dummy_vec, dummy_vec, dummy_vec, dummy_vec, dummy_vec,
                            ETA0, ETA, GGG, SXY, COH, TEN, FRI, WT,
                            rhototalm, dummy_vec, dummy_vec, dummy_vec, dummy_vec,
                            RHOX, RHOFX, KX, PHIX, RX, WTX,
                            RHOY, RHOFY, KY, PHIY, RY, WTY,
                            dummy_vec, dummy_vec, dummy_vec, dummy_vec, dummy_vec, dummy_vec,
                            GGGP, SXX, RHO, RHOCP, ALPHA, ALPHAF, HR, PHI, TK, WTP
                        )
                    end
                end
            end
