...
@testset verbose=true "Erebus.jl" begin
    ...
    @testset "setup_staggered_grid_properties()" begin 
        ...
        (
            ...
            DHP,
            XWS
        ) = Erebus.setup_staggered_grid_properties()
    ...
    @testset "setup_staggered_grid_properties_helpers()" begin
        ...
        (
            ...
            DSXX,
            tk0
        ) = Erebus.setup_staggered_grid_properties_helpers()
        # test
    ...
    @testset "setup_interpolated_properties()" begin
        ...
        (
            ...
            XWSSUM,
            WTPSUM
        ) = Erebus.setup_interpolated_properties()
    ...
    @testset "reset_interpolated_properties!()" begin
        ...
        Erebus.reset_thermochemical_properties!(
    ...
    @testset "setup_marker_properties()" begin
        ...
        (
            ...
            XWsolidm,
            XWsolidm0
        ) = Erebus.setup_marker_properties(marknum)
    ...
    @testset "setup_marker_properties_helpers()" begin
        ...
        (
            ...
            alphasolidcur,
            alphafluidcur
        ) = Erebus.setup_marker_properties_helpers(marknum)
        # test
    ...
    @testset "define_markers!() & compute_marker_properties!()" begin
        ...
        for m = 1:1:marknum
            ...
            if tm[m]<3
                rhocpfluidm_ver = Erebus.compute_rhocpfluidm(
                    tkm[m], mode)
                ksolidm_ver = Erebus.compute_ksolidm(
                    tkm[m], mode)
                kfluidm_ver = Erebus.compute_kfluidm(
                    tkm[m], mode)
                # rocks
    ...
    @testset "grid_vector()" begin
        ...
        @test Erebus.grid_vector(1, 1, grid) == @SVector [
    ...
    @testset "grid_average()" begin
        grid = rand(rgen, 10, 10)
        @test Erebus.grid_average(1, 1, grid) == 0.25 * (
            grid[1, 1] + grid[2, 1] + grid[1, 2] + grid[2, 2])
    ...
    @testset "interpolate_add_to_marker!()" begin
        ...
        for m=1:1:marknum
            i, j, weights = Erebus.fix_weights(
                xm[m], ym[m], x, y, dx, dy, jmin, jmax, imin, imax)
            Erebus.interpolate_add_to_marker!(
                m, i, j, weights, property, grid)
    ...
    @testset "marker_to_basic_nodes!()" begin
        ...
        (
            ...
            etavpm,
            _
        ) = Erebus.setup_marker_properties(
        ...
        (
            ...
            _,
            _
        ) = Erebus.setup_marker_properties_helpers(
            marknum, randomized=true)
        (
            ETA0SUM,
            ETASUM,
    ...
    @testset "compute node properties: basic, Vx, Vy, P, thermodynamic" begin
        ...
        @testset "compute_thermodynamic_xfer!()" begin
            ...
            Erebus.compute_thermodynamic_xfer!(
    ...
    @testset "update_marker_temperature!()" begin
        ...
        for timestep = 1:2
            ...
            Erebus.update_marker_temperature!(
