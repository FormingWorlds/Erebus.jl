...
Ensure you have Julia 1.13 or later installed. Install `Erebus.jl` via the Julia package manager:
...
2. Verify that all tests pass:
   ...
   julia --project=. test/runtests.jl
   ```
3. Open a pull request against `main`. Continuous Integration verifies test execution on Julia 1.13, and enforces formatting and documentation builds on Julia 1.13.
